...
const $$Terminos = createComponent(async ($$result, $$props, $$slots) => {
  const idioma = "es";
...
}, "C:/AiRoboticsAstro/src/pages/es/terminos.astro", void 0);

const $$file = "C:/AiRoboticsAstro/src/pages/es/terminos.astro";
const $$url = "/es/terminos";
