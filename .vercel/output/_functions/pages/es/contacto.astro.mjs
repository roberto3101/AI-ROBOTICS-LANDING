...
const $$Contacto = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const asunto = Astro2.url.searchParams.get("asunto") ?? "";
  ...
  } }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "HeroNosotros", $$HeroNosotros, { "etiqueta": datos.hero.etiqueta, "titulo": datos.hero.titulo, "subtitulo": datos.hero.subtitulo, "imagen": "/imagenes/hero/empresa-3.jpg" })} ${maybeRenderHead()}<section class="bg-[#050506] py-20 lg:py-32"> <div class="container grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-start"> <div> <p class="sub-title">[DATOS DE CONTACTO]</p> <h2 class="section-title section-title--mobile mt-6 mb-8">Conversemos.</h2> ${renderComponent($$result2, "InfoContacto", $$InfoContacto, { "items": datos.datosContacto })} </div> ${renderComponent($$result2, "Formulario", $$Formulario, { "formulario": datos.formulario, "tiposConsulta": datos.tiposConsulta, "textosUi": textosUi, "asuntoInicial": asunto })} </div> </section> ` })}`;
}, "C:/AiRoboticsAstro/src/pages/es/contacto.astro", void 0);

const $$file = "C:/AiRoboticsAstro/src/pages/es/contacto.astro";
