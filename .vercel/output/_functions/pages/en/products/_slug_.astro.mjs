...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const producto = datos.lista.find((p) => p.slugEn === slug);
  if (!producto) {
    return Astro2.redirect("/en/products", 302);
  }
