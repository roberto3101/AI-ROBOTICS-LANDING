...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!slug) return Astro2.redirect("/en/blog", 302);
  const post = await obtenerPostPorSlug();
  if (!post) return Astro2.redirect("/en/blog", 302);
